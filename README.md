...
[![CI](https://github.com/SergeyViskov/hw05_final/actions/workflows/python-app.yml/badge.svg?branch=master)](https://github.com/yandex-praktikum/hw05_final/actions/workflows/python-app.yml)
...
```
git clone https://github.com/SergeyViskov/hw05_final.git
```
